    ...
    <div class="container">
        <form method="POST" class="form" id="form-2">
            ...
            <?php } else { ?>
                ...
                <div class="dcap">
                    <button class="submit box-cmt-item btn-send"  name="submit2" ><a class="help-submit" href="login?idPhongTro=<?php echo $_GET['idPhongTro']; ?>&idNhaTro=<?php echo $_GET['idNhaTro']; ?>&comment=true">GỬI</a></button>
                    <!--               -->
                </div>
            <?php } ?>
        </form>
...
class commentController
{
    ...
    public function __invoke()
    {
        ...
        if (isset($_POST['submit2']) && !$this->checkComment) {
            ...
            if ($rescheck) {
                ...
                echo '<meta http-equiv="refresh" content="0;url=login?idPhongTro=' . $_GET['idPhongTro'] . '&idNhaTro=' . $_GET['idNhaTro'] . '&comment=true">';
            }
        }
    }
}
